...
| --- | --- | --- | --- | --- |
| 2 | `day2_intro_context` | `bottom-right` | 900ms | 5000ms |
| 2 | `day2_proactive_chat` | `top-left` | 900ms | 5000ms |
| 3 | `day3_avatar_tools` | `bottom-left` | 900ms | 5000ms |
...
| 5 | `day5_character_settings` | `top-right` | 2900ms | 5000ms |
| 6 | `day6_plugin_dashboard` | `bottom-right` | 900ms | 5000ms |
| 6 | `day6_agent_task_hud` | `top-left` | 900ms | 5000ms |
| 7 | `day7_memory_review` | `bottom-left` | 900ms | 5000ms |
